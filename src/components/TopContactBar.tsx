        ...
        >
            ...
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
                <a href="mailto:lunexwebstudio@gmail.com" style={socialLinkStyle}
                    ...
                    <svg width="14" height="14" viewBox="0 0 24 24" style={{ color: 'var(--accent-gold)' }}>
                        {iconMail} {iconMailPoly}
                    </svg>
                    <span style={{ display: 'inline-block' }} className="hide-mobile">lunexwebstudio@gmail.com</span>
                </a>

                <div className="hide-mobile" style={{ width: '1px', height: '14px', background: 'rgba(255,255,255,0.1)' }}></div>
